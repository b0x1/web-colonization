...
export type SaveData = SaveGameState;
...
export class SaveSystem {
  ...
  static deserialize(serialized: string): SaveGameState | null {
    try {
  ...
  private static isValidSaveData(data: unknown): data is SaveGameState {
