...
describe('Unit', () => {
  it('should initialize with correct values', () => {
    const unit = new Unit('unit-1', 'player-1', UnitType.COLONIST, 10, 10, 3);
